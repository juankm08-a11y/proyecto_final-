...
async function start() {
    ...
    try {
        ...
        console.error("Error conectando a Kafka:",e)
    }
    ...
    connection.on("ready", () => {
        ...
        connection.queue(
            ...
            (queue) => {
                ...
                console.log(`Cola enlazada a exchange "${DELAY_EXCHANGE}" con routing key "${DELAY_ROUTING_KEY}"`)
                ...
                queue.subscribe(async (msg,Headers,info) => {
                    try {
                        ...
                        console.log(
                            "Mensaje recibido en match_simulator",
                            data
                        )
                        const finishedMsg = {
